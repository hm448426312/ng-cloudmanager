...
var LeftMenuComponent = (function () {
    function LeftMenuComponent(broadcast, router, activeRoute) {
    ...
    Object.defineProperty(LeftMenuComponent.prototype, "menus", {
        get: function () {
            return this._menus;
        },
        set: function (v) {
    ...
    Object.defineProperty(LeftMenuComponent.prototype, "selectMenu", {
        get: function () {
    ...
    LeftMenuComponent.prototype.selectTheMenu = function (menu) {
        if (!menu || !this.menus) {
            return;
        }
        var result = [];
    ...
    LeftMenuComponent.prototype.setMenuActive = function (menus) {
    ...
    LeftMenuComponent.prototype.findTheMenu = function (result, menu, datas) {
        for (var i = 0; i < datas.length; i++) {
            ...
            if (datas[i].children && datas[i].children.length > 0) {
                var res = this.findTheMenu(result, menu, datas[i].children);
                if (res) {
                    result.unshift(datas[i]);
                    return true;
                }
    ...
    LeftMenuComponent.prototype.menuClick = function (ev, menu, type, isopen) {
        if (type == 1) {
            if (isopen === true) {
    ...
    LeftMenuComponent.prototype.getIconStyle = function (menu) {
    ...
    LeftMenuComponent.propDecorators = {
        "menus": [{ type: core_1.Input },],
        "selectMenu": [{ type: core_1.Input },],
        "menuEvent": [{ type: core_1.Output },],
    };
