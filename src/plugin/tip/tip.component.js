...
var TipComponent = (function () {
    function TipComponent(router, resolver, elementRef, injector, applicationRef) {
        this.router = router;
    ...
    TipComponent.prototype.ngDoCheck = function () {
    };
    ...
    TipComponent.prototype.closeComponent = function () {
        var _this = this;
        this.show = false;
        setTimeout(function () {
    ...
    TipComponent.prototype.ngOnChanges = function (changes) {
    };
